...
class ExportDocxAbstract(models.AbstractModel):
    ...
    def generate_docx_report(self, data, objs):
        ...
        msg_text_ar  = msg_text_ar + "\n"
        msg_text_ar  = msg_text_ar + "نشهد بأن "
        msg_text_ar  = msg_text_ar + "محمد ابو صبحية "
        msg_text_ar  = msg_text_ar + "رقم بطاقه  "
        msg_text_ar  = msg_text_ar + "٩٩٥١٠١٢٥٧٩"
        msg_text_ar  = msg_text_ar + "\n"
        msg_text_ar  = msg_text_ar + "على وظيفة "
        ...
        msg_text_ar = msg_text_ar + "\n"
        msg_text_ar = msg_text_ar + "بدل سكن :"
        msg_text_ar = msg_text_ar + "٢٠٠٠ "
        msg_text_ar = msg_text_ar + "ريال"
        msg_text_ar = msg_text_ar + "\n"
        msg_text_ar = msg_text_ar + "بدل نقل :"
        msg_text_ar = msg_text_ar + "٢٠٠٠ "
        msg_text_ar = msg_text_ar + "ريال"
        msg_text_ar = msg_text_ar + "\n"
        ...
        msg_text_ar = msg_text_ar + "ريال"
        msg_text_ar = msg_text_ar + "\n\n"
        msg_text_ar = msg_text_ar + "وأنه بناء على طلبه، أصدرت هذه الشهادة دون أي مسؤولية  "
        msg_text_ar = msg_text_ar + "\n"
        msg_text_ar = msg_text_ar + "."
        msg_text_ar = msg_text_ar + "أو التزام تجاه الشركة"
        msg_text_ar = msg_text_ar + "\n"
        msg_text_ar = msg_text_ar + "..."
        ...
        row_Cells = menuTable.add_row().cells
        row_Cells[0].width = Cm(7.82)
        row_Cells[1].width = Cm(0.87)
        row_Cells[2].width = Cm(9.3)
        msg_text_final = "\n"
        ...
        row_Cells[0].text = msg_text_final
        paragraph_row_2 = row_Cells[0].paragraphs[0]
        run_row_2 = paragraph_row_2.runs
        font_row_2 = run_row_2[0].font
        font_row_2.size= Pt(16)
        font_row_2.bold = True
