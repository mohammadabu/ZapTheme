...
class AttendanceReportExcel(models.TransientModel):
    ...
    def get_xlsx_report(self, data, response):
        ...
        sheet.write_comment(2, 2, 'ساعات التأخر النهائية')
        sheet.write_comment(2, 3, 'ساعات التأخر')
        sheet.write_comment(2, 4, 'أيام الخروج بدون اذن')
        sheet.write_comment(2, 5, 'أيام الغياب')
        sheet.write_comment(2, 6, 'اسم الموظف')
        sheet.write_comment(2, 7, 'رقم الهوية')
        sheet.write_comment(2, 8, 'م')
